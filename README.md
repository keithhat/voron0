...
# Main Info
* http://192.168.7.60/#/
** Alternatively: http://192.168.7.61/#/
* username: fly
...
I bought following:
	...
	* Filament unblock tool (when nozel removed): https://www.aliexpress.com/item/1005002948629438.html 	AUD 2.95
		** I made a seperate heatbreak and heat block that could be connected to umbilical and moved from printer to help unblock.
			*** Heaer Block: https://www.aliexpress.com/item/1005005038625574.html 	AU 8.99 	Up to 500deg. Missing silicon sock, I got the wrong one.
	* Nozzle Needless:
...
* Gemini v3 mainboard
* V0 Umbilical
	** This is fairly still; a CAM bus or USB equivalent think would be useful in future

# Guides - Assembly, FW and Tuning
* Siboor v0.2 r1 Aug: https://docs.siboor.com/siboor-0.2-r1-aug
	** Initial Startup: https://docs.siboor.com/siboor-0.2-r1-aug/the-build/initial-startup
* Gemini v3:
...
## Info:
	* Dragon Burner v8 Home: https://github.com/chirpy2605/voron/blob/main/V0/Dragon_Burner/README.md
